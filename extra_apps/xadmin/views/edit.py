    ...
    def post_response(self):
        ...
        if "_addanother" in request.POST:
            ...
            if "_redirect" in request.POST:
                ...
                return "/{app}/{modelname}/{id}/detail".format(app=self.app_label,modelname=self.model_name,id=self.new_obj.id)
            else:
    ...
    def post_response(self):
        ...
        if "_continue" in request.POST:
            ...
            if "_redirect" in request.POST:
                ...
                # change_list_url = self.model_admin_url('detail')
                ...
                return request.path.replace("update","detail")
            else:
                return self.get_admin_url('index')
