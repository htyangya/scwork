...
class ImportMenuPlugin(BaseAdminPlugin):
    ...
    def init_request(self, *args, **kwargs):
        ...
        isexport = self.user.has_perm('%s.export_%s' % model_info)
        return isexport and bool(self.import_export_args.get('import_resource_class'))
...
class ExportMenuPlugin(ExportMixin, BaseAdminPlugin):
    ...
    def init_request(self, *args, **kwargs):
        model_info = self.opts.app_label, self.opts.model_name
        isexport = self.user.has_perm('%s.export_%s' % model_info)
        return isexport and bool(self.import_export_args.get('export_resource_class'))
