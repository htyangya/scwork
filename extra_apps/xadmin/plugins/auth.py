...
class UserAdmin(object):
    ...
    list_display = ('username','nick_name','department','company','groups','gender', 'is_staff','is_active','last_login')
    list_editable=['is_staff',  'is_active']
    list_filter = ('is_staff', 'is_superuser', 'is_active')
    search_fields = ('nick_name','username', 'first_name', 'last_name', 'email')
    ordering = ('-last_login',)
            ...
            self.form_layout = (
                Main(
                    ...
                    Fieldset(_('Personal info'),
                             Row('nick_name', 'gender','mobile'),
                             'email',
                             Row('first_name','department'),'company'
                             ),
